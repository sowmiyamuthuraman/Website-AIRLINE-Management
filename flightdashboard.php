...
<br><br>
<div class="group">
  <form action="updateflight.php">
<input  class="button" type="submit" value="MANAGE FLIGHT"/></form>
<br><br><br>
<div class="group">
  <form action="cancelticket.php">
<input  class="button" type="submit" value="CANCEL TICKET"/></form>
<br><br><br>
<div class="group">
  <form action="notify.php">
<input  class="button" type="submit" value="MANAGE NOTIFICATION"/></form>
<br><br><br>