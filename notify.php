...
<form action="web.php">
<input  class="button" type="submit" value="WEB NOTIFICATION"/><br><br></form>
<div class="group">
  <form action="smstest.php">
<input  class="button" type="submit" value="SMS NOTIFICATION"/><br><br></form>
<div class="group">
  <form action="maildial.php">
<input  class="button" type="submit" value="Mail NOTIFICATION"/><br><br></form>
