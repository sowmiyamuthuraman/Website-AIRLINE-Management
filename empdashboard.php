...
<input  class="button" type="submit" value="MANAGE EMPLOYEE"/><br><br><br><br></form>
<div class="group">
  <form action="manageleave.php">
<input  class="button" type="submit" value="MANAGE LEAVE"/><br><br></form>
